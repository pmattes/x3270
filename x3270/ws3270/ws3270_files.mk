...
WS3270_SOURCES = XtGlue.c gdi_print.c glue.c macros.c menubar_stubs.c \
	readres.c s3270.c snprintf.c ssl_dll.c strtok_r.c w3misc.c windirs.c \
	winprint.c winvers.c

WS3270_OBJECTS = XtGlue.$(OBJ) gdi_print.$(OBJ) glue.$(OBJ) macros.$(OBJ) \
	menubar_stubs.$(OBJ) readres.$(OBJ) s3270.$(OBJ) snprintf.$(OBJ) \
	ssl_dll.$(OBJ) strtok_r.$(OBJ) w3misc.$(OBJ) windirs.$(OBJ) \
