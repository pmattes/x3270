...
WC3270_SOURCES = XtGlue.c c3270.c ft_gui.c glue.c help.c icmd.c keymap.c \
	keypad.c menubar.c nvt_gui.c pr3287_session.c relink.c screen.c \
	scroll.c select.c shortcut.c ssl_passwd_gui.c windirs.c winvers.c
...
WC3270_OBJECTS = XtGlue.$(OBJ) c3270.$(OBJ) ft_gui.$(OBJ) glue.$(OBJ) \
	...
	nvt_gui.$(OBJ) pr3287_session.$(OBJ) relink.$(OBJ) screen.$(OBJ) \
	scroll.$(OBJ) select.$(OBJ) shortcut.$(OBJ) ssl_passwd_gui.$(OBJ) \
	windirs.$(OBJ) winvers.$(OBJ)
