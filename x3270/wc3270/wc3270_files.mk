...
WC3270_SOURCES = XtGlue.c c3270.c ft_gui.c gdi_print.c glue.c help.c icmd.c \
	...
	readres.c relink.c screen.c scroll.c select.c shortcut.c ssl_dll.c \
...
WC3270_OBJECTS = XtGlue.$(OBJ) c3270.$(OBJ) ft_gui.$(OBJ) gdi_print.$(OBJ) \
	...
	select.$(OBJ) shortcut.$(OBJ) ssl_dll.$(OBJ) ssl_passwd_gui.$(OBJ) \
	windirs.$(OBJ) winprint.$(OBJ) winvers.$(OBJ)
...
WC3270_HEADERS = X11/keysym.h ckeypad.h cmenubar.h conf.h cscreen.h cstatus.h \
	...
	relinkc.h shlobj_missing.h shortcutc.h ssl_dll.h windirsc.h \
	winprint.h winversc.h wselectc.h xscroll.h
