...
LIB3270_SOURCES = Malloc.c actions.c apl.c asprintf.c bind-opt.c charset.c \
	...
	httpd-nodes.c idle.c lazya.c linemode.c print_screen.c proxy.c \
	readres.c resolver.c rpq.c see.c sf.c tables.c toggles.c unicode.c \
	unicode_dbcs.c utf8.c varbuf.c
...
LIB3270_OBJECTS = Malloc.$(OBJ) actions.$(OBJ) apl.$(OBJ) asprintf.$(OBJ) \
	...
	lazya.$(OBJ) linemode.$(OBJ) print_screen.$(OBJ) proxy.$(OBJ) \
	readres.$(OBJ) resolver.$(OBJ) rpq.$(OBJ) see.$(OBJ) sf.$(OBJ) \
	tables.$(OBJ) toggles.$(OBJ) unicode.$(OBJ) unicode_dbcs.$(OBJ) \
	utf8.$(OBJ) varbuf.$(OBJ)
