...
LIB3270_SOURCES = Malloc.c actions.c apl.c asprintf.c bind-opt.c charset.c \
	ctlr.c fprint_screen.c ft.c ft_cut.c ft_dft.c host.c httpd-core.c \
	httpd-io.c httpd-nodes.c idle.c kybd.c lazya.c linemode.c macros.c \
...
LIB3270_OBJECTS = Malloc.$(OBJ) actions.$(OBJ) apl.$(OBJ) asprintf.$(OBJ) \
	...
	host.$(OBJ) httpd-core.$(OBJ) httpd-io.$(OBJ) httpd-nodes.$(OBJ) \
	idle.$(OBJ) kybd.$(OBJ) lazya.$(OBJ) linemode.$(OBJ) macros.$(OBJ) \
