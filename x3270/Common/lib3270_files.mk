...
LIB3270_SOURCES = Malloc.c XtGlue.c actions.c apl.c asprintf.c bind-opt.c \
	...
	linemode.c macros.c print_screen.c proxy.c readres.c resolver.c rpq.c \
	see.c sf.c tables.c telnet.c toggles.c trace.c unicode.c \
	unicode_dbcs.c utf8.c util.c varbuf.c xio.c
...
LIB3270_OBJECTS = Malloc.$(OBJ) XtGlue.$(OBJ) actions.$(OBJ) apl.$(OBJ) \
	...
	linemode.$(OBJ) macros.$(OBJ) print_screen.$(OBJ) proxy.$(OBJ) \
