...
LIB3270_SOURCES = Malloc.c XtGlue.c actions.c apl.c asprintf.c b8.c \
	bind-opt.c charset.c ctlr.c fprint_screen.c ft.c ft_cut.c ft_dft.c \
	glue.c host.c httpd-core.c httpd-io.c httpd-nodes.c idle.c kybd.c \
	lazya.c linemode.c llist.c macros.c nvt.c print_screen.c proxy.c \
	readres.c resolver.c resources.c rpq.c see.c sf.c tables.c telnet.c \
