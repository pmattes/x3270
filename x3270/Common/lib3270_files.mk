...
LIB3270_SOURCES = Malloc.c actions.c apl.c asprintf.c bind-opt.c charset.c \
	...
	resolver.c rpq.c see.c sf.c tables.c toggles.c unicode.c \
...
LIB3270_OBJECTS = Malloc.$(OBJ) actions.$(OBJ) apl.$(OBJ) asprintf.$(OBJ) \
	...
	resolver.$(OBJ) rpq.$(OBJ) see.$(OBJ) sf.$(OBJ) tables.$(OBJ) \
	toggles.$(OBJ) unicode.$(OBJ) unicode_dbcs.$(OBJ) utf8.$(OBJ) \
	varbuf.$(OBJ)
