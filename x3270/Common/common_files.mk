...
COMMON_SOURCES = charset.c ctlr.c ft.c ft_dft.c host.c idle.c kybd.c \
	linemode.c nvt.c print_screen.c proxy.c resources.c rpq.c sf.c \
	tables.c telnet.c toggles.c trace.c unicode.c unicode_dbcs.c util.c \
	xio.c
...
COMMON_OBJECTS = charset.$(OBJ) ctlr.$(OBJ) ft.$(OBJ) ft_dft.$(OBJ) \
	host.$(OBJ) idle.$(OBJ) kybd.$(OBJ) linemode.$(OBJ) nvt.$(OBJ) \
	print_screen.$(OBJ) proxy.$(OBJ) resources.$(OBJ) rpq.$(OBJ) \
	sf.$(OBJ) tables.$(OBJ) telnet.$(OBJ) toggles.$(OBJ) trace.$(OBJ) \
