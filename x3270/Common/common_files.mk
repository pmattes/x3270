...
COMMON_SOURCES = charset.c ctlr.c fprint_screen.c ft.c ft_cut.c ft_dft.c \
	host.c idle.c kybd.c linemode.c nvt.c print_screen.c proxy.c \
...
COMMON_OBJECTS = charset.$(OBJ) ctlr.$(OBJ) fprint_screen.$(OBJ) ft.$(OBJ) \
	ft_cut.$(OBJ) ft_dft.$(OBJ) host.$(OBJ) idle.$(OBJ) kybd.$(OBJ) \
	linemode.$(OBJ) nvt.$(OBJ) print_screen.$(OBJ) proxy.$(OBJ) \
	resources.$(OBJ) rpq.$(OBJ) sf.$(OBJ) tables.$(OBJ) telnet.$(OBJ) \
