...
X3270_OBJECTS = Cme.o CmeBSB.o CmeLine.o CmplxMenu.o Husk.o about.o child.o \
	...
	keysym2ucs.o macros.o menubar.o nvt_gui.o popups.o pr3287_session.o \
	print_gui.o print_window.o printer_gui.o save.o screen.o scroll.o \
	select.o ssl_passwd_gui.o status.o stmenu.o trace_gui.o x3270.o xaa.o \
	xactions.o xkybd.o xutil.o
