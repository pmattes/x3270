...
X3270_SOURCES = Cme.c CmeBSB.c CmeLine.c CmplxMenu.c Husk.c about.c dialog.c \
	...
	idle_gui.c keymap.c keypad.c keysym2ucs.c menubar.c nvt_gui.c \
	popups.c pr3287_session.c print_gui.c print_window.c printer_gui.c \
	save.c screen.c scroll.c select.c ssl_passwd_gui.c status.c stmenu.c \
