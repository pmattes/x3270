...
#
#        # Start s3270.
#        s3270 = Popen(["s3270", "127.0.0.1:9990"], stdin=PIPE, stdout=DEVNULL)
#
#        # Feed s3270 some actions.
#        s3270.stdin.write(b'transfer direction=send host=vm "localfile=s3270/Test/fttext" "hostfile=ibmlink trc a"\n')
